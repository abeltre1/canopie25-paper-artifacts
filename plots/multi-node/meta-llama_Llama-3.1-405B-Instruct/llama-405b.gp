...
plot \
    datafile using 1:2 title "ClusterA HPC, Run 1             (clustera 39-42)"          with linespoints lw 3 lc rgb 'red', \
    datafile using 1:3 title "ClusterA HPC, Run 2             (clustera 22-25)"          with linespoints lw 3 lc rgb 'orange', \
    datafile using 1:4 title "ClusterA HPC, Run 3 (clustera 28, 37-38, 58)"  with linespoints lw 3 lc rgb 'green'
