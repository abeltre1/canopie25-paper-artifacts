...
# real id out of sbatch output that also carries INFO chatter (field: clustera emits
# "sbatch: INFO: Adding filesystem licenses to job: gpfs:1,sitescratch:1,...").
...
class SlurmScheduler(Scheduler):
    ...
    def parse_job_id(self, submit_stdout: str) -> str:
        ...
        # noise on the same stream — e.g. clustera prints
