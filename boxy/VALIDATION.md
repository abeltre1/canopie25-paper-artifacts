...
| GPU-request rejection (kahuna GRES) | auto-recover retry, both submit paths | ✅ |

## Turnkey commands added this session

`boxy serve` interactive WCID picker; `boxy generate card <hf-id>`; GRES
...
- Real HPC submission on hops/eldorado/cronus/kahuna — exercised via fake-cluster
